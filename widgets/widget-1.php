...
class Widget_1 extends Widget_Base {
    ...
    public function get_name() {
        return 'custom-widget-1'; 
    }

    public function get_title() {
        return __( 'Widget 1', 'custom-elementor-react-addon' );
    }
    ...
    public function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .custom-widget-1' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    ...
    protected function render() {
		...
		echo '<div class="custom-widget-1" data-settings="' . esc_attr(json_encode($data)) . '"></div>';
  ...
  protected function content_template() {
    ...
    #>
    <div class="custom-widget-1" data-settings="{{ jsonData }}"></div>
    <?php
  }
}
